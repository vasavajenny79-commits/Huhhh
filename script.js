...
// Aapki uploaded files ke exact names
const gifs = {
    shy: "shy.webp",
    sad: "sad.webp",
    crying: "crying.webp",
...
noBtn.addEventListener("click", () => {
    noCount++;
    hasTouchedNo = true;
    music.play().catch(() => {}); // Music starts on interaction
    ...
    noBtn.style.transform = `scale(${Math.max(0.3, 1 - noCount * 0.1)})`;
});
